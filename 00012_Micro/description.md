¡Estamos de vuelta con un nuevo `MedioDeTransporte`! `Micro` :bus: también es una de sus subclases, y tiene algunas variaciones. En principio, además de inicializarse con cero `@litros`, arranca con cero `@pasajeros`.
